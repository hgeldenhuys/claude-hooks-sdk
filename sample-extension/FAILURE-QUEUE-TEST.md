...
echo '{"hook_event_name":"PreToolUse","session_id":"test-1","tool_name":"Read","tool_input":{"file_path":"/test"},"cwd":"/path/to/your/project","transcript_path":"/Users/username/.claude/transcripts/latest.jsonl"}' | bun sample-extension/failure-queue-demo.ts

# Expected: Exit code 1, event added to queue

# Event 2: Will be queued because queue is not empty
echo '{"hook_event_name":"PostToolUse","session_id":"test-2","tool_name":"Write","tool_input":{"file_path":"/test"},"cwd":"/path/to/your/project","transcript_path":"/Users/username/.claude/transcripts/latest.jsonl"}' | bun sample-extension/failure-queue-demo.ts
